...
import { describePreparedIsolation } from "../isolation/launcher.js";
...
const handlers: Handlers = {
  ...
  "prepare-isolation": async ({ applicationRoot, runtime, resolvedTarget }) =>
    describePreparedIsolation(
      await prepareIsolation(applicationRoot, runtime, resolvedTarget),
    ),
};
